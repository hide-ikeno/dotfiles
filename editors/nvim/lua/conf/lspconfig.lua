...
local custom_attach = function(client, bufnr)
  ...
  -- key mappings
  buf_set_keymap("n", "<C-f>", "<cmd>lua require'lspsaga.action'.smart_scroll_with_saga(1)<CR>",  opts_nowait)
  buf_set_keymap("n", "<C-b>", "<cmd>lua require'lspsaga.action'.smart_scroll_with_saga(-1)<CR>", opts_nowait)
  ...
  if client.resolved_capabilities.document_range_formatting then
    buf_set_keymap("n", "m=", "<cmd>lua vim.lsp.buf.range_formatting()<CR>", opts)
    buf_set_keymap("x", "m=", "<cmd>lua vim.lsp.buf.range_formatting()<CR>", opts)
  end
...
lspconfig.efm.setup{
  ...
  filetypes = {
    "eruby", "css", "csv", "dockerfile", "html", "json", "make", "markdown", "rst", "yaml",
    "blade", "elixir", "javascript", "lua", "python", "php", "sh", "typescript", "vim"
  },
  init_options = {
